...
1. Make sure you have [Node.js](https://nodejs.org/en/download/) installed on your Mac. Double check it got installed by checking what version you are on `node --version`.
